...
export const WeatherWidget = () => {
    ...
    const fetchWeather = async () => {
      ...
      try {
        ...
        if (data && data.data && data.data.length > 0) {
          ...
          const allForecasts: WeatherData[] = weatherData
            .flat()
            .map((item: any) => ({
          ...
          const daily: DailyForecast[] = Object.keys(grouped)
            .slice(0, 3)
            .map((date) => {
        ...
        <div className="flex items-center gap-1.5">
          {current ? (
            <>
              ...
              <span className="text-[10px] opacity-70 uppercase tracking-wider hidden md:block">
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="p-3 bg-white/5 border-b border-white/10 flex justify-between items-center cursor-pointer hover:bg-white/10 transition-colors"
          ...
          <>
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <div className="text-4xl font-bold text-white flex items-start">
                  {current.t.toFixed(0)}
                  <span className="text-lg text-blue-300 font-normal mt-1">
                    °C
                  </span>
                </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-2">
                <Calendar size={10} />3 Hari Kedepan
              </div>
