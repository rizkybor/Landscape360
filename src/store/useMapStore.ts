...
interface MapState {
  ...
  setShowCustomLocations: (show: boolean) => void;
...
export const useMapStore = create<MapState>()(
  persist(
    (set) => ({
      ...
      setShowCustomLocations: (showCustomLocations) => set({ showCustomLocations }),
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        showCustomLocations: state.showCustomLocations,
